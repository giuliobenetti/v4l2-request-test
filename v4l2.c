			       ...
			       enum codec_type type, union controls *frame)
{
	struct {
		...
		{ CODEC_TYPE_MPEG2, "sequence",
		  V4L2_CID_STATELESS_MPEG2_SEQUENCE,
		  &frame->mpeg2.sequence,
		  sizeof(frame->mpeg2.sequence) },
		{ CODEC_TYPE_MPEG2, "picture",
		  V4L2_CID_STATELESS_MPEG2_PICTURE,
		  &frame->mpeg2.picture,
		  sizeof(frame->mpeg2.picture) },
		{ CODEC_TYPE_MPEG2, "quantization matrices",
		  V4L2_CID_STATELESS_MPEG2_QUANTISATION,
		  &frame->mpeg2.quantisation,
		  sizeof(frame->mpeg2.quantisation) },
		...
		{ CODEC_TYPE_H264, "picture parameter set",
		  V4L2_CID_STATELESS_H264_PPS, &frame->h264.pps,
		...
		{ CODEC_TYPE_H264, "sequence parameter set",
		  V4L2_CID_STATELESS_H264_SPS, &frame->h264.sps,
		  sizeof(frame->h264.sps) },
		{ CODEC_TYPE_H264, "pred weights",
		  V4L2_CID_STATELESS_H264_PRED_WEIGHTS, &frame->h264.pred_weights,
		  sizeof(frame->h264.pred_weights) },
#endif
		...
		{ CODEC_TYPE_H265, "decode parameters",
		  V4L2_CID_MPEG_VIDEO_HEVC_SLICE_PARAMS,
		  &frame->h265.decode_params, sizeof(frame->h265.decode_params) },
#endif
	};
	unsigned int i;
	int rc;
